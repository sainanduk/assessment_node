...
// ---------- ROUTES ----------
// Prefix: /attempts
router.get("/attempts", authenticateToken, attemptCtrl.list);
router.get("/attempts/:id", authenticateToken, attemptCtrl.get);
router.post("/attempts/:assessmentId", authenticateToken, attemptCtrl.create);
router.post("/attempts/:id/submit", authenticateToken,attemptCtrl.submit);      // special submit endpoint
